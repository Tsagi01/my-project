    ...
    <main className="mx-auto flex w-full max-w-6xl flex-1 flex-col gap-8 px-6 py-8">
      ...
      <section className="rounded-2xl border border-blue-100 bg-white p-6 shadow-sm">
        ...
        <p className="max-w-3xl text-slate-800">
          This version shows a simple product catalogue for 357 Ltd. Products
          are hard-coded, pagination is enabled, and the basket is saved in the
          browser for prototype purposes.
        </p>
      </section>
      ...
      <section id="products">
        <div className="mb-4">
          ...
          <p className="text-slate-800">
            Each item shows the name, category, price, and stock. This page
